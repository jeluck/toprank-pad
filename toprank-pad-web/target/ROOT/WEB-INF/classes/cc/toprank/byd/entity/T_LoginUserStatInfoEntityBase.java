 ...
 *   如有需要扩展的字段，请在T_LoginUserStatInfo类中进行修改
 * 
 * ********************************************************************************************************************/
public class T_LoginUserStatInfoEntityBase extends Entity {
   ...
   *	LogoutTime数据库列名
   */
  public final static java.lang.String LOGOUTTIME_FIELD =  "LogoutTime";
  
  /**
   *	LogoutTime字段中文名，用于视图展示
   */
  public final static java.lang.String LOGOUTTIME_LABLE = "注销时间";
  
  /**
   *	LogoutTime对应的java字段名,业务操作使用这个字段。
   */
   ...
   */
  public final static java.lang.String USERNAME_LABLE = "用户姓名";
