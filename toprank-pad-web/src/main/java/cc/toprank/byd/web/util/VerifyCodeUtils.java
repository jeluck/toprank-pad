...
public class VerifyCodeUtils {
     ...
     * @throws IOException
     */
    public static void outValid(HttpServletResponse response, int w, int h, String verifyCode) throws IOException {
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        for (int i = 0; i < verifySize; i++) {
            ...
            affine.setToRotation(Math.PI / 4 * rand.nextDouble() * (rand.nextBoolean()
                                                                    ? 1
                                                                    : -1), (w / verifySize) * i + fontSize / 2, h / 2);
